...
struct proc*    pickthread(struct proc* master);
...
//mysheduler.c
int             push_MLFQ(struct proc* p, int level);
int             pop_MLFQ(struct proc* p);
struct proc*    exec_MLFQ(void);
int             level_change_MLFQ(struct proc* p, int level);
int             tick_add_MLFQ(void);
void            boost_priority(void);
struct proc*    choose_lowpass(int);
int             set_cpu_share(int);
struct proc*    pickthread(struct proc* master);
void            setthreadtick(struct proc* thread);
void            increasealltick(struct proc* p);
